...
declare module "carlo" {
    ...
    export class App {
         ...
         */
        public load(url: string, ...params: (Serializable | Handle<any>)[] ): Promise<any>
        /**
...
console.log(await window.evaluate(`1 + ${x}`));  // prints "11" ```
         ...
         */
        public load(url:string, ...params:Array<Serializable | Handle<any>>):Promise<any>
        /**
    ...
    type PromisifiedFunction<T extends AnyFunction> =
        T extends (arg0: infer P, arg1: infer P, arg2: infer P, arg3: infer P) => infer R ? (...args: P[]) => Promise<Unpacked<R>> : T
    /**
